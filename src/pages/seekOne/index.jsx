...
class seekOne extends Component {
  render() {
    return (
      <Container>
        <SectionOne>
          <SectionWrapper>
            <SectionOneLeft>
              <OneTitle>SeekOne</OneTitle>
              <OneContext>
                SeekOne<Sub>TM</Sub>single cell sequencing platform provide an efficient approach to prepare mRNA sequencing library from 1000-10000
